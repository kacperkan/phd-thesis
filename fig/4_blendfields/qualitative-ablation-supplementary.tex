...
\renewcommand{\versionone}{
  \tikzsetnextfilename{blendfields_qualitative_ablation_supplementary}
  \begin{tikzpicture}[
      >=stealth',
      overlay/.style={
          anchor=south west,
...
\begin{figure*}[htb]
  ...
  \caption[Qualitative ablation over the number of training expressions in \blendfields]{\textbf{Qualitative ablation over the number of training expressions} -- {
      ...
      All other consecutive rows show the images rendered with \blendfields while
      increasing the number of training expressions.
      The last row, $\nExpr{=}5$ corresponds to the results presented in the main
      part of the article.
