...
\renewcommand{\versionone}{
  ...
  {
    \def\leftimageheight{4.5cm}
    \def\rightimageheight{4.5cm}
    \begin{tikzpicture}[
        >=stealth',
        overlay/.style={
            anchor=south west,
...
\begin{figure}[t]
  ...
  \caption[Example failure cases of \blendfields]{\textbf{Failure cases} -- {
      We show failure cases for our proposed approach.
      \textit{Left:}
      In the presence of wrinkles in low-contrast images, \blendfields takes longer
      to converge to make wrinkles visible.
      ...
      in~\cref{fig:blendfields-synthetic-qualitative} after $2{\times}10^5$ steps.
