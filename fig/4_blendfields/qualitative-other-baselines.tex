...
\begin{figure*}[htb]
  ...
  \caption[Qualitative comparison between \blendfields and other data-driven approaches]{\textbf{Comparison to strictly data-driven approaches} --
    ...
    Those baselines rely on the data continuity in the training set (\eg, from a
    video), and cannot generalize to any other expression.
  }
