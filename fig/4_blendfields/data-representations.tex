\begin{figure}[t]
    ...
    \begin{subfigure}[b]{\linewidth}
      ...
      \resizebox{0.8\linewidth}{!}{
        \begin{tikzpicture}[
          ...
          % \node[below right=\offset and \offset of datarep-1-5.north west, overlay]{
  ...
  \caption[Example data samples using to train \blendfields]{\textbf{Data} -- We represent the data as a multi-view, multi-expression images.
    For each of these images, we obtain parameters of a parametric model, such as
    FLAME \cite{li2017flame} to get: an expression vector $\expression$ and a
    tetrahedral mesh described by vertices $\meshVertices(\expression)$.
    We highlight that our approach works for any object if a rough mesh and its
    descriptor are already provided.
  }
