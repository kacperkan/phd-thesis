...
\newcommand{\clogpipelinefig}{
  ...
  % Scale the entire figure to page width, preserving coordinates
  ...
  \begin{tikzpicture}[
      ...
      \node[above right=0pt and 2.2pt of pictures-2-1.north, scale=0.4] (firstnet) {\rotatebox{90}{\usebox\neuralnet}};
      \node[above=-4.4pt of firstnet.north] {\smaller \cref{eq:clog-decoders}};
      \node[above right=0pt and 2.2pt of pictures-2-2.north, scale=0.4]{\rotatebox{90}{\usebox\neuralnet}};
      \node[above right=0pt and 2.2pt of pictures-2-3.north, scale=0.4]{\rotatebox{90}{\usebox\neuralnet}};
      \node[above right=0pt and 2.2pt of pictures-2-4.north, scale=0.4]{\rotatebox{90}{\usebox\neuralnet}};
      \node[above right=0pt and 2.2pt of pictures-2-5.north, scale=0.4]{\rotatebox{90}{\usebox\neuralnet}};

      \node[right=-11pt of data.west, align=center, anchor=base] (stageone) {\rotatebox{90}{Stage I}};
      \node[right=-16.5pt of pictures-2-1.west, align=center]{\rotatebox{90}{\smaller Grid of Latents~$\cloglatents$}};
      \node[above=0pt of data.north, align=center] {Calibrated cameras};
      ...
      \node[right=11pt of pictures.east] (preplas) {\includegraphics[height=\inputheight]{assets/\clogdirname/plas/unsorted_colors.png}};
      \node[below=33pt of preplas.south] (postplas) {\includegraphics[height=\inputheight]{assets/\clogdirname/plas/sorted_colors.png}};k
      \node[above=0pt of preplas.north, align=center] {Trained Grid};
      ...
      \node[above left=2.75pt and 38.5pt of postplas, anchor=north east, scale=1.15] (modulator) {\rotatebox{180}{\usebox\neuralnet}};

      \matrix[
        matrix of nodes,
        left=132pt of postplas.west,
        column sep=0pt,
        row sep=0pt,
        ampersand replacement=\&,
        inner sep=0,
      ...
      \node[above=-5.5pt of modulator] {Our modulator $\modulator$};

      \node[below=198pt of stageone.south, align=center, anchor=base] {\rotatebox{90}{Stage II}};
      ...
      \node[right=-16.5pt of secondstage-1-1.west, align=center] {\small\rotatebox{90}{\textbf{Ours}}};
      \node[right=-16.5pt of secondstage-2-1.west, align=center] {\small\rotatebox{90}{For comparison}};
...
\begin{figure}
  ...
  \caption[Pipeline of \clog]{
    ...
    For any desired level of detail (LoD), we obtain the corresponding UV map by
    downsampling and processing it through a modulator that adapts the features to
    map correctly to 3D Gaussians at reduced density.
