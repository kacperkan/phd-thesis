...
\begin{figure}
  \centering
  \clogqualitativefig
  \caption[Qualitative results of \clog under varying levels of detail (LoD)]{
    ...
    various levels, and provides a better tradeoff than FLoD~\cite{seo2024flod}.
    We showcase the results for $\lod{\in}\{0.1, 0.5, 1.0\}$ for our method, and
    $\text{LoD}{=}\{2,3,5\}$ for FLoD to roughly match the number of Gaussians.
  }
