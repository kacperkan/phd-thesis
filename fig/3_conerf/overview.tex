\begin{figure}
  ...
  \end{subfigure}
  \vspace{-0.7em}
  \caption[Pipeline of \conerf]{{\bf Framework -- }
    We depict in (a) the HyperNeRF~\cite{park2021hypernerf} formulation, and (b)
    our Controllable-NeRF~(CoNeRF).
    ...
    In (b), we introduce regressors $\Attribute$ and $\MaskNet$ that regress the
    attribute and the corresponding mask that enable few-shot attribute-based
    control of the NeRF model.
