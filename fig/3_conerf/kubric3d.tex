\begin{figure}
  ...
  \caption[Qualitative comparison between \conerf and baselines]{{\bf Novel view and novel attribute synthesis on synthetic data -- }
    ...
    controllability and results in all three objects having the same attribute in
    the rendered scene.
  }
