\begin{figure}
  ...
  \end{subfigure}
  \caption[Example of annotations used to train \conerf]{{\bf Annotation example -- }
    We provide only a rough annotation for each attribute, which is enough for the
    method to discover the mask for each attribute across all views automatically.
