...
\begin{figure}
  ...
  \begin{subfigure}[t]{0.595\linewidth}
    ...
    \caption{renderings}
  \end{subfigure}
  \caption[Example of how \conerf handles the unannotated attributes]{{\bf Example with unannotated attributes --}
    We show an example of how our method performs when a part of the image changes
    appearance, but is not annotated.
    ...
    As shown, the change that is not annotated is simply encoded in the per-image
    encoding $\bbeta$.
  }
