...
\begin{figure}[!t]
  ...
  \vspace{-3em}
  % \relighting
  \caption[Scene reconstruction and relightning capabilities of \lumigauss]{\textbf{Scene reconstruction and relightning --}
    ...
    We use learned environment maps to relight the scene from novel viewpoints and
    then relight arbitrary objects within a graphics engine.
  }
