...
\begin{figure}[!t]
  ...
  \shadowedunshadowed
  \caption[A simple visualization of how \lumigauss handles occluders to produce shadows]{
    ...
    environment light.
    In the case of any occluder, $\radiance$ does not handle, and the color does
    not change.
    However, our proposed $\shadowedradiance$ properly reacts to the occluder and
    makes the output color darker.
  }
