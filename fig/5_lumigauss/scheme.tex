...
\begin{figure*}[!t]
  ...
  \caption[Pipeline of \lumigauss]{
    ...
    Our contributed method composes the Gaussians in two modes---\textit{shadowed}
    and \textit{unshadowed}.
    The \textit{shadowed} model reconstructs additional shadows
    (see~\cref{fig:lumigauss-teaser}) on top of the unshadowed model thanks to our
    proposed use of a radiance transfer function.
    The Gaussians are splatted~\cite{kerbl20233d,zhang2024gaussian} to render the
    output image in a novel view and light.
  }
