...
\begin{figure}[!t]
  ...
  \rotatingfigure
  \caption[Novel lightning synthesis capabilities of \lumigauss under an environment map rotation]{\textbf{Environment map rotation --}
    ...
    % Note that shadows appear even in brightly illuminated areas, indicating that
    % this is not a result of a dark environment map. 
