...
\begin{figure}[!t]
  \centering
  \qualitative
  \caption[Showcase of novel view synthesis using our shadowed radiance transfer in \lumigauss]{
    ...
    Please see zoom-ins to see details on the quality difference, such as surface
    smoothness and edge sharpness of small building elements.
    ...
    renders for NeRF-OSR and \lumigauss \textbf{does not match} the illumination
    in ground truth.
