...
\begin{figure}[t]
  ...
  % normals.pdf}
  \normalsshadows
  \caption[Qualitative results showcasing how our shadow radiance transfer affects the results in \lumigauss]{\textbf{Effects of shadowed training --}
    We show the comparison of \textbf{albedo} between the shadowed (\textit{left})
    and unshadowed (\textit{right}) models.
