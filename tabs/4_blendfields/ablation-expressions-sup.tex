\begin{table}[!t]
  ...
  \caption[Ablation study showcasing how the number of training expressions affects the results in \blendfields]{\textbf{Number of training expressions} -- {
      ...
      Increasing the number of available training expressions consistently improves
      the results.
