\begin{table*}[!t]
  ...
  \resizebox{\linewidth}{!}{
    \begin{tabular}{lccccccc|c}
      \toprule
                                 & NeRF~\cite{mildenhall2020nerf} & NeRFies~\cite{park2021nerfies} & HyperNeRF~\cite{park2021hypernerf} & NeRFace~\cite{gafni2021dynamic} & NHA~\cite{neural_head_avatars} & AVA \cite{cao2022authentic} & VolTeMorph~\cite{garbin2024voltemorph} & \textbf{Ours} \\
      \midrule
