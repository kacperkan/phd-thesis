\begin{table}
  ...
  \begin{tabular}{@{}lccc ccc@{}}
    ...
    \textbf{32.394}                           & \textbf{0.972}                           & \textbf{0.139}                                                                                    \\ \bottomrule\end{tabular}
  \caption[Effect of loss functions applied in \conerf]{ \textbf{{Effect of loss
          functions --}} We report the rendering quality of our method as we
    procedurally introduce the loss terms.
    % < \resizebox 
