...
\begin{table}[!t]
  ...
  \caption[Quantitative comparison between \clog and chosen baselines under varying levels of detail]{\textbf{Quantitative results (varying levels of detail) --}
    We report the performance of each method that supports different levels of
    detail.
