...
\begin{table}[t]
  ...
  \caption[Quantitative results between \lumigauss and chosen baselines]{\textbf{Quantitative results --}
    Comparison between our \lumigauss and selected baselines for two different.
    We report the reconstruction quality regarding PSNR, MSE, MAE, SSIM on full
    and 4x downsampled image resolutions.
    ...
    We use $\dagger$ to further annotate our approach where we remove loss terms
    ...
    fidelity.
    It reliably produces smooth surfaces and sharp edges, reflected in its high
    SSIM values.
