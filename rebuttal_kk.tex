...
\paragraph{Odpowiedź.}
  ...
  warunkowane tylko lokalnym sąsiedztwem czworościanów, lokalne zmiany
  w~przestrzeni są niezależne od siebie. To powoduje, że nawet przy
  ...
  predykować nowe zmarszczki przy minimalnym nakładzie danych.
