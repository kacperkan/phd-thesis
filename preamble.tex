...
% Disable tikzexternalize for arXiv compatibility (requires shell-escape)
% \tikzexternalize
...
\newcommand{\cloginputimage}{Undefined}
\newcommand{\cloglossweight}[1]{\alpha_{\text{#1}}}
\newcommand{\clogimage}{\mathcal{I}}
\newcommand{\imageset}{\{\image\}}
\newcommand{\cameraset}{\mathcal{C}}
\newcommand{\cameras}{C}
\newcommand{\gaussianset}{\mathcal{G}}
\newcommand{\lod}{l}
\newcommand{\modulator}{\mathcal{M}}
\newcommand{\cloglatents}{\boldsymbol{\Lambda}}
\newcommand{\networkparams}{\boldsymbol{\Theta}}
\newcommand{\modulatorparams}{\networkparams^\modulator}
\newcommand{\cloglatent}{\boldsymbol{\lambda}}
\newcommand{\mean}{\boldsymbol{\mu}}
\newcommand{\quat}{\boldsymbol{q}}
\newcommand{\scales}{\boldsymbol{s}}
\newcommand{\colors}{\boldsymbol{c}}
\newcommand{\newwidth}{W'}
\newcommand{\newheight}{H'}
\newcommand{\latentdim}{D}
\newcommand{\threedcoords}{\bm{x}^\texttt{3D}}
\newcommand{\twodcoords}{\bm{x}^\texttt{2D}}
\newcommand{\uniform}{\mathcal{U}}
\newcommand{\regularizer}{\Omega}
\newcommand{\numgaussians}{G}
\newcommand{\down}[1]{#1_\downarrow}
\newcommand{\up}[1]{#1_\uparrow}
\newcommand{\modulated}[1]{\tilde{#1}}
\newcommand{\offset}{\boldsymbol{\beta}}
\newcommand{\scale}{\boldsymbol{\gamma}}
\newcommand{\sigmoid}{\sigma}
\newcommand{\positionalemb}{f}
\newcommand{\rotationfun}{r}
\newcommand{\covariance}{\Sigma}
\newcommand{\pred}[1]{\hat{#1}}
\newcommand{\renderingop}{\mathcal{R}}
\newcommand{\imagecoord}{\mathbf{u}}
\newcommand{\locationnoise}{\boldsymbol{\eta}}
\newcommand{\normaldistribution}{\mathcal{N}}
\newcommand{\threshold}[1]{\tau_{#1}}
\newcommand{\error}{e}
...
\newcommand{\activatepolishconjunctions}{%
  \catcode`\a=\active \def a{a~}%
  \catcode`\i=\active \def i{i~}%
  \catcode`\o=\active \def o{o~}%
  \catcode`\u=\active \def u{u~}%
  \catcode`\w=\active \def w{w~}%
  \catcode`\z=\active \def z{z~}%
}

\newcommand{\fixpolishtext}[1]{%
  \begingroup
  #1%
  \endgroup
}