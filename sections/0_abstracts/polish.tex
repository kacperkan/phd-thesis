\streszczeniepracy{%
  ...
  Pokazujemy, że rzadkie, ręczne adnotacje, które można uzyskać w~ciągu minuty,
  ...
  Modelowanie drobnych deformacji, jak marszczenie się na twarzy, oraz efektów,
  które te deformacje mają na otaczającą przestrzeń, wymaga wielu wysokiej
  jakości adnotacji w~obrębie ujęć z~wielu kamer.
  Aby zredukować tę zależność jakości obrazów od ilości danych, przedstawiamy
  nową metodę, \blendfields, która modeluje te deformacje przy pomocy kilku ujęć
  z~wielu kamer.
  ...
  W~tym celu, wykorzystujemy reprezentację przestrzeni, która przyjmuje formę
  sieci czworościanów.
  ...
  i~interpretowalną interpolację między znanymi ``granicznymi'' deformacjami.
