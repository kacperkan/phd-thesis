In this chapter, we extend neural 3D representations to allow for intuitive
and interpretable user control beyond novel view rendering (i.e. camera
control).
...
by the neural network given the scene encoding.
