...
\section{Results}
  ...
  \subsection{Experimental setup}
    ...
    \paragraph{Datasets.}
      ...
      We also use the DTU~\cite{aanaes2016large} dataset to evaluate performance on
  ...
  \subsection{At the finest level}
    ...
    We provide qualitative examples in \cref{fig:clog-qualitative} and a summary
    in \cref{tab:clog-quantitative}.
